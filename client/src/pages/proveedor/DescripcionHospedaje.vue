          ...
          <q-card-section horizontal>
            ...
            <div class="column full-width">
              ...
              <q-card class="bordes q-my-md q-pa-md shadow-up-4" style="border-radius:10px;min-height:240px">
                <div class="text-subtitle2 q-ml-md q-pt-xs">Nombre del Alojamiento:</div>
                ...
                <div class="text-subtitle2 q-ml-md q-pt-xs">Precio por noche:</div>
                <div class="q-pa-md">${{form.price}}</div>
                <div class="text-subtitle2 q-ml-md q-pt-xs">Metros Cuadrados:</div>
                <div class="q-pa-md">{{form.dimensions}}Mts</div>
                <div class="text-subtitle2 q-ml-md q-pt-xs">Tipo de mascotas:</div>
                <div class="q-pa-md">{{form.pet_type}}</div>
              </q-card>
            </div>
          </q-card-section>
        </q-card>
