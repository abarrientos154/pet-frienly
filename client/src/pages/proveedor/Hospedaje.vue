<template>
  <div>
    ...
    <div class="row justify-center">
        <div class="text-h6 q-ma-md text-center estilo-titulos">Servicio de Hospedaje</div>
    </div>
      ...
      <q-card class="q-pa-md bordes" v-for="(item, index) in data" :key="index" v-ripple>
        <div class="row justify-between">
          ...
          <div class="column justify-around">
            ...
            <q-btn round flat color="white" size="sm" text-color="red" icon="delete" @click="deleteServicio(item._id)" />
          </div>
        </div>
      </q-card>
    </q-list>
    <q-card v-else class="shadow-2 q-ma-md q-pa-md">
      <div class="text-center text-subtitle1">Actualmente sin srevicios...</div>
    </q-card>
  </div>
</template>
